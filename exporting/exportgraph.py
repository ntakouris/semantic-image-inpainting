...
def freeze_graph(model_folder, output_nodes='y_hat', 
    ...
    saver = tf.train.import_meta_graph(model_folder, clear_devices=True)
...
# python exportgraph.py --checkpoint_path target/DCGAN-model.ckpt-50000.meta --output_nodes z-noise,generator/Tanh,loss/g_loss,x-images,logistic_loss_2,discriminator/Sigmoid --output_graph awesomegan-50k.pb